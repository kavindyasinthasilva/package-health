...
```bash
npx @kavindyasinthasilva/package-health
```

Or install globally:

```bash
npm install --global @kavindyasinthasilva/package-health
package-health
```
...
```js
import { checkPackageHealth } from "@kavindyasinthasilva/package-health";
